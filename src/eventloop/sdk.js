;(function(e, t) {
  ...
  return (function(e) {
    ...
    function(e, t, i) {
          ...
          (d.IS_MOBILE
            ? ((e.flash = !1),
              d.IS_X5TBS && e.x5_player
                ? (w.mobile = ['flv', 'm3u8', 'mp4'])
                : d.IS_ENABLED_MSE && e.h5_flv && (w.mobile = ['flv', 'm3u8', 'mp4']))
      ...
      function u(e, t) {
        for (
          var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : S, o = '', n = 0;
          n < i.length;
          n++
        )
          if (((o = i[n]), e[t][o]))
      ...
      ;(t.IS_ENABLED_FLASH = (function() {
          ...
          try {
            if (navigator.plugins && navigator.plugins.length > 0 && (e = navigator.plugins['Shockwave Flash'])) {
              for (var o = e.description.split(' '), n = 0; n < o.length; ++n)
                isNaN(parseInt(o[n])) ||
                  ((t.FLASH_VERSION = v = o[n]), window.console && console.log('FLASH_VERSION', parseInt(o[n])))
              return !0
            }
          } catch (i) {
            return !1
        ...
        (t.IS_ENABLED_MSE = (function() {
          var e = (window.MediaSource = window.MediaSource || window.WebKitMediaSource),
            ...
            o =
              !t ||
              (t.prototype && 'function' == typeof t.prototype.appendBuffer && 'function' == typeof t.prototype.remove)
          return i && o
        })()),
    ...
    function(e, t, i) {
      ...
      function c(e, t) {
        b.off(t.video.el, 'webkitbeginfullscreen', c),
          'webkitbeginfullscreen' == e.type
            ? (b.on(t.video.el, 'webkitendfullscreen', function(e) {
                c(e, t)
              }),
              _.pub(
                {
            ...
            : 'webkitendfullscreen' == e.type &&
              (b.off(t.video.el, 'webkitendfullscreen', c),
              _.pub(
                {
                  type: g.MSG.FullScreen,
                  src: 'util',
      ...
      function p(e, t, i) {
        ...
        ;(p.player = e),
          E.requestFullscreen
            ? t
              ? (b.on(document, E.fullscreenchange, l), i && i[E.requestFullscreen]())
              : document[E.exitFullscreen]()
            : o && e.video.el.webkitEnterFullScreen
            ? (b.on(e.video.el, 'webkitbeginfullscreen', function(t) {
                c(t, e)
              }),
              t ? e.video.el.webkitEnterFullScreen() : e.video.el.webkitExitFullscreen())
            : ((p.__isFullscreen = t),
              p.__isFullscreen
                ? ((p.__origOverflow = document.documentElement.style.overflow),
                  (document.documentElement.style.overflow = 'hidden'),
                  b.on(document, 'keydown', u))
                : ((document.documentElement.style.overflow = p.__origOverflow), b.off(document, 'keydown', u)),
        ...
        return (
          (e.prototype.render = function(e) {
            ...
            ;(this.poster = new E['default'](this)),
              ...
              (((L.IS_SAFARI && parseInt(L.SAFARI_VERSION) > 10) || L.IOS_VERSION > 10) &&
                'system' == this.options.controls) ||
                ((this.bigplay = new w['default'](this)), this.bigplay.render(this.el))
            var n = void 0
            ;(n = !(
          ...
          (e.prototype.verifyOptions = function() {
            return L.IE_VERSION && x.compareVersion(L.IE_VERSION, '8.0') == -1
              ? (this.errortips.show({
                  code: 5,
                }),
                !1)
                ...
                i
                  ? ((this.__type = f.VideoType.M3U8),
                    'undefined' == typeof window.Hls
                      ? h.loadScript(f.CDNPath + r, function() {
                  ...
                  : o &&
                    ...
                    'undefined' == typeof window.flvjs
                      ? h.loadScript(f.CDNPath + 'libs/flv.min.js', function() {
        ...
        _ = (function(e) {
          ...
          return (
                  ...
                  case 'netStatus':
                    this.options.live ||
                      ('NetStream.Buffer.Full' == t.code
                        ? (this.__prevPlayState == m.PlayStates.PAUSED || this.__prevPlayState == m.PlayStates.STOP,
                          (this.__prevPlayState = null),
                          (i.type = p.MSG.Seeked))
            ...
            (t.prototype.play = function(e) {
              this.playState == m.PlayStates.PAUSED || this.playState == m.PlayStates.PLAYING || e
                ? this.el.playerResume()
                : this.playState != m.PlayStates.PLAYING && this.el.playerPlay()
            }),
            (t.prototype.togglePlay = function() {
              this.metaDataLoaded
                ? this.playState == m.PlayStates.PAUSED
                  ? this.el.playerResume()
                  : this.playState == m.PlayStates.PLAYING
                  ? this.el.playerPause()
                  : this.playState == m.PlayStates.STOP
            ...
            (t.prototype.render = function(t) {
              return (
                ...
                this.options.videoSource &&
                  ...
                  !T.IS_MOBILE &&
                  ((this.claritySwitcher = new S['default'](this.player)), this.claritySwitcher.render(this.el)),
                e.prototype.render.call(this, t)
              )
            }),
            (t.prototype.setup = function() {
